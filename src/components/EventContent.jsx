      ...
      <div className="flex justify-center  flex-wrap flex-row h-full w-full bg-white ">
        <div className="flex justify-center items-center md:w-full xl:w-9/12 bg-white md:mx-auto  flex-col ">
          ...
          <div className="w-4/5  bg-white">
            <h1 className="text-black-200 text-2xl">ini merupakan Judul</h1>
            <p className="text-black">
            Selamat datang di acara pemahaman Mendalam tentang Polusi sebuah kesempatan unik untuk menjelajahi aspek-aspek yang mendalam dari masalah lingkungan yang semakin mendesak, yaitu polusi. Acara ini didesain untuk memberikan wawasan mendalam kepada peserta mengenai dampak polusi terhadap lingkungan dan kesehatan manusia, sambil mendorong partisipasi aktif dalam upaya melawan polusi.
            </p>
          </div>
