...
function FormAdminUpdate() {
  return (
    <div>
      <div className="bgFor text-white py-14">
        ...
        <div className="w-2/4 h-2/6 m-auto  bg-white rounded-xl">
          <div className="px-14 py-14 text-black">
            ...
            <div className="flex justify-between">
              <Button className="mt-5 bg-maincolor"> Update</Button>
              <Button className="mt-5 bg-maincolor"> Reset </Button>
            </div>
          </div>
        </div>
      </div>
...
export default FormAdminUpdate;
